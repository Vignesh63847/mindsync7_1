  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isLogin) {
        ...
        if (error) throw error;
        toast({ title: "Welcome to MindSync!", description: "Your account has been created." });
        navigate("/");
      }
    } catch (err: any) {
      ...
      >
        <div className="glass-strong rounded-2xl p-8 border border-border/50">
          ...
          <div className="flex flex-col items-center mb-8">
            <div className="w-12 h-12 rounded-xl bg-primary/20 flex items-center justify-center glow-border mb-3">
            ...
            <p className="text-muted-foreground text-sm mt-1">
              {isLogin ? "Sign in to your safe space" : "Create your personal wellness companion"}
            </p>
          </div>
